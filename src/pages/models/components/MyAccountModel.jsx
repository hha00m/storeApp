            ...
            <List
                ...
                <Item>
                                    <Flex
                                        ...
                                        <Flex.Item style={{ flex: '5', fontSize: '   16px' }}>{props.user.data.user_details.name}</Flex.Item>
                                    </Flex>
                                </Item>
                                <Item>
                                    <Flex
                                        ...
                                        <Flex.Item style={{ flex: '5', fontSize: '   16px' }}>{props.user.data.user_details.phone}</Flex.Item>
                                    </Flex>
                                </Item>
                                <Item>
                                    <Flex
                                        ...
                                        <Flex.Item style={{ flex: '5', fontSize: '   16px' }}>{props.user.data.role==1?'مدير':'مندوب بيعات'}</Flex.Item>
                                    </Flex>
                                </Item> 
                                <Item>
                                    <Flex
                                        ...
                                        <Flex.Item style={{ flex: '5', fontSize: '   16px' }}>{props.user.data.user_details.email}</Flex.Item>
                                    </Flex>
                                </Item>
                                <Item>
                                    <Flex
                                        >
                                            <img src={`https://albareqExpress.com/store/img/${props.user.data.user_details.id_copy}`} alt=""/>     </Flex>
                                </Item>
